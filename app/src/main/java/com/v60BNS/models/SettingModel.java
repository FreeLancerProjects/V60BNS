...
public class SettingModel implements Serializable {
    ...
    private String site_commission;
    private String debt_limt;
    private String stories_time_in_days;
    ...
    public String getSite_commission() {
        return site_commission;
    }

    public String getDebt_limt() {
        return debt_limt;
    }

    public String getStories_time_in_days() {
